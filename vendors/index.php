...
<div class="panel-main">
    <div class="panel-header">
        <div class="panel-header-actions">
            ...
            <a href=<?=isset($_POST['submit']) ? "/exportcsv.php?table=tbl_Vendor&filter=true&key={$columnMap[$_POST['key']]}&operator={$_POST['operator']}&value=" . urlencode($_POST['value']) : "/exportcsv.php?table=tbl_Vendor&filter=false"?>><img src="/public/images/exportcsv.svg" /></a>
        </div>
