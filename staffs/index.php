...
<div class="panel-main">
    <div class="panel-header">
        <div class="panel-header-actions">
            ...
            <a href=<?=isset($_POST['submit']) ? "/exportcsv.php?table=tbl_Staff&filter=true&key={$columnMap[$_POST['key']]}&operator={$_POST['operator']}&value={$_POST['value']}" : "/exportcsv.php?table=tbl_Staff&filter=false"?>><img src="/public/images/exportcsv.svg" /></a>
        </div>
