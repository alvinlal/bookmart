...
<div class="panel-main">
    <div class="panel-header">
        <div class="panel-header-actions">
            ...
            <a href=<?=isset($_POST['submit']) ? "/exportcsv.php?table=tbl_Staff&filter=true&key=" . urlencode($columnMap[$_POST['key']]) . "&operator=" . urlencode($_POST['operator']) . "&value=" . urlencode($_POST['value']) : "/exportcsv.php?table=tbl_Staff&filter=false"?>><img src="/public/images/exportcsv.svg" /></a>
        </div>
...
function observerCallback(entries, observer) {
    entries.forEach((entry) => {
        if (entry.isIntersecting) {
            ...
            fetch(<?=isset($_POST['submit']) ? "`/staffs?filter=true&key={$_POST['key']}&value={$_POST['value']}&operator={$_POST['operator']}&offset=" . '${offset}`' : "`/staffs?filter=false&offset=" . '${offset}`'?>)
...
class Row {
    constructor(data) {
        ...
        const rowHtml = `
            ...
            <div class="cell" data-title="Actions">
                <div class="table-actions">
                    <a href="/staffs/edit_staff.php?id=${data['Staff_id']}"><img src="/public/images/edit.svg" /></a>
                </div>
            </div>
        `
